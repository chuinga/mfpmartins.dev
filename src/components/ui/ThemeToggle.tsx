...
export function ThemeToggle(): React.ReactNode {
  ...
  if (!mounted) {
    return (
      <button
        className="w-10 h-10 rounded-full flex items-center justify-center bg-card-bg border border-card-border"
